...
<details>
  ...
  <ul>
    <li>
      <a href="https://manikangkandas.github.io/asityin/">View Demo</a>
    </li>
    <li>
      <a href="https://github.com/manikangkandas/asityin/issues">Report Bug</a>
    </li>
    <li>
      <a href="https://github.com/manikangkandas/asityin/issues">Request Feature</a>
    </li>
    <li>
...
asityin is clone of linkedin with a more resposive & clean fronted built on the top of next.js.
...
1. Clone the repo
   ...
   ```sh
   git clone https://github.com/manikangkandas/asityin.git
   ```
...
<br />
Project Link - [https://github.com/manikangkandas/asityin](https://github.com/manikangkandas/asityin)
